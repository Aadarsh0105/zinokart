...
const APP_CARDS: AppCard[] = [
{
  ...
  icon: SmartphoneIcon,
  iconBackground: 'bg-brand-indigo/10',
...
},
{
  ...
  icon: StoreIcon,
  iconBackground: 'bg-brand-cyan/10',
...
},
{
  ...
  icon: BikeIcon,
  iconBackground: 'bg-brand-emerald/10',
...
export function Hero() {
  ...
  return (
    <section
      ...
      <div className="pointer-events-none absolute inset-0 -z-20 bg-[radial-gradient(circle_at_72%_38%,rgba(6,182,212,0.14),transparent_28%),radial-gradient(circle_at_18%_76%,rgba(79,70,229,0.10),transparent_25%)]" />
      <motion.div
        aria-hidden="true"
        className="pointer-events-none absolute -right-24 top-20 -z-10 h-72 w-72 rounded-full bg-brand-cyan/15 blur-[100px] sm:h-96 sm:w-96"
        animate={
        reducedMotion ?
        undefined :
        {
      ...
      <motion.div
        aria-hidden="true"
        className="pointer-events-none absolute -left-28 bottom-10 -z-10 h-64 w-64 rounded-full bg-brand-indigo/15 blur-[100px] sm:h-80 sm:w-80"
        animate={
        reducedMotion ?
        undefined :
        {
      ...
      <div className="relative mx-auto grid max-w-7xl gap-x-10 px-5 sm:px-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-center xl:gap-x-16">
        ...
        <motion.div
          ...
          <div className="relative mx-auto aspect-[1/1.08] w-full max-w-[540px] overflow-visible rounded-[2rem] border border-white/70 bg-white/45 shadow-[0_28px_80px_-40px_rgba(15,23,42,0.25)] backdrop-blur-sm sm:rounded-[2.5rem]">
            ...
            <div className="pointer-events-none absolute left-1/2 top-1/2 h-[48%] w-[48%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-brand-indigo/20 blur-[70px]" />
            ...
            <svg
              ...
              <defs>
                <linearGradient
                  ...
                  <stop offset="0.52" stopColor="#06B6D4" stopOpacity="0.8" />
            ...
            <motion.span
              ...
              aria-hidden="true"
              className="pointer-events-none absolute z-10 h-1.5 w-1.5 rounded-full bg-brand-cyan/70 shadow-[0_0_14px_rgba(6,182,212,0.85)]"
              style={{
                left: particle.left,
                top: particle.top
              }}
            ...
            <motion.div
              ...
              <div className="absolute -inset-8 -z-10 rounded-full bg-brand-indigo/25 blur-[46px]" />
            ...
            <div className="absolute bottom-[8%] left-1/2 z-30 -translate-x-1/2 rounded-full border border-brand-indigo/15 bg-white/85 px-2.5 py-1 text-[8px] font-semibold text-brand-indigo shadow-soft backdrop-blur-xl sm:px-3 sm:py-1.5 sm:text-[10px]">
