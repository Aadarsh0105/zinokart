...
function FaqItem({
  ...
  return (
    <div className="border-b border-[#F3E5C6]">
      <button
        type="button"
        onClick={onToggle}
        ...
        <motion.span
          ...
          className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full transition-colors ${isOpen ? 'bg-[#F5A300] text-white' : 'bg-[#FFF4DA] text-[#F5A300]'}`}>
...
export function FAQ() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#FFFEFC] py-8 sm:py-10">
      <div className="pointer-events-none absolute right-0 top-1/4 -z-10 h-72 w-72 rounded-full bg-[#FFE7B0]/35 blur-[120px]" />
